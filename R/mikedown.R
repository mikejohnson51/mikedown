...
# Features of the CSU Template
csu <- function(toc = TRUE, code_folding = "hide", number_sections=TRUE) {

  # get the locations of resource files located within the package
  css <- system.file("rmarkdown", "templates", "csu" ,"resources", "style.css", package = "mikedown")
  template <- system.file("rmarkdown", "templates", "csu" ,"resources", "template_csu.html", package = "mikedown")
